# Generated by Django 3.2 on 2021-07-01 20:04
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('FM', 'Формируется'), ('STR', 'Отправлен в обработку'), ('PRD', 'Обработан'), ('PD', 'Оплачен'), ('RD', 'Готов к выдаче'), ('CNC', 'Отменён'), ('DVD', 'Выдан')], default='FM', max_length=3, verbose_name='статус')),
